    ...
    return {
        ...
        description: (
            <p className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">5 lygis:</span> U-vamzdelis su pasvirusia dešine šaka. Įpilkite skysčių ir stebėkite kaip kinta vandens lygis.
            </p>
        ),
        controls: (
            <Button
